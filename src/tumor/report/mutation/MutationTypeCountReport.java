 ...
 * lattice site.
 */
public abstract class MutationTypeCountReport extends TumorRecordReport<MutationTypeCountRecord> {
    /**
     ...
     */
    protected MutationTypeCountReport(String sampleIntervalProperty,
